...
curl -X "https://api.publitas.com/v2/groups/1/publications/222/online?api_key=<api_key>"
```
...
| 402  | Your online publications limit has been reached |

## Mark a publication as offline

```shell
# This endpoint marks a publication as being offline.
curl -X "https://api.publitas.com/v2/groups/1/publications/222/offline?api_key=<api_key>"
```
