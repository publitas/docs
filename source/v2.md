...
| public_url          | String   | Publication public URL                                           |
...
| downloading | PDF is being downloaded from its origin.                 | No             |
...
```json
{
    "publication": {
        ...
        "schedule_online_at": null,
        "schedule_offline_at": null,
        "public_url": "https://view.publitas.com/example-group/winter2014"  
    }
}
```
